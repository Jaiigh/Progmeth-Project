...
import static Utils.Constant.EnemyConstants.ATTACK;
import static Utils.Constant.EnemyConstants.DEAD;
...
public class Player extends Entity {
    ...
    private void setAttackBoxOnRightSide() {
        attackBox.x = hitbox.x + hitbox.width - (int) (GamePane.SCALE * 5);
    }

    private void setAttackBoxOnLeftSide() {
        attackBox.x = hitbox.x - hitbox.width - (int) (GamePane.SCALE * 10);
    }
